...
import {doc, updateDoc, getDoc, serverTimestamp} 
...
// Edit listing by clicking the edit button from the profile page 
...
function EditListing() {
  ...
  // Redirect if listing does not belong to the current user 
  useEffect(() => {
  ...
  // fetch existing listing info and populate the edit form 
  useEffect(() => {
    setLoading(true)
  ...
  // if user is logged in, set userRef to that user
